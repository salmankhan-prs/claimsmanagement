...
/*
DROP TABLE IF EXIST MEMBER_CLAIM;
create table member_claim (policy_id int ,member_id int,claim_id int,provider_id int,benefit_id int,total_billed_amount double,total_claimed_amount double,claim_status varchar(20),claim_description varchar(255));
